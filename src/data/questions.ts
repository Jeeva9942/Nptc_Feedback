...
export const participationQuestions: Question[] = [
  { id: 1, text: 'Did you participate in Sports events?', section: 'participation', type: 'yesno' },
  { id: 2, text: 'Did you participate in Seminar?', section: 'participation', type: 'yesno' },
  { id: 3, text: 'Did you participate in Workshop?', section: 'participation', type: 'yesno' },
  { id: 4, text: 'Are you did any Industry Project?', section: 'participation', type: 'yesno' },
  { id: 5, text: 'Are you member in Students Guild of Service (SGS)?', section: 'participation', type: 'yesno' },
  { id: 6, text: 'Are you a NSS Volunteer?', section: 'participation', type: 'yesno' },
  { id: 7, text: 'Have you received any scholarships during the study?', section: 'participation', type: 'yesno' },
  { id: 8, text: 'Did you attend any certified courses inside the campus (Swelect, Bosch, 3D Modeling, etc.)?', section: 'participation', type: 'yesno' },
  { id: 9, text: 'Do you attend any awareness program?', section: 'participation', type: 'yesno' },
];
